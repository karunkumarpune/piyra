...
public class HomeSolutionsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_solutions);
    ...
    private void getId() {
        toolbar = (Toolbar) findViewById(R.id.include_toolbar_home_solutions);
    ...
    private void setData() {
        ...
        tvToolbarText.setText("Home Solutions");
