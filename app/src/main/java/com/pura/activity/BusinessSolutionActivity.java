...
public class BusinessSolutionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_business_solution);
    ...
    private void getId() {
        toolbar = (Toolbar) findViewById(R.id.include_toolbar_home_business_solutions);
    ...
    private void setData() {
        ...
        tvToolbarText.setText("Business Solutions");
