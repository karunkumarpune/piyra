...
public class PastOrdersAdapter extends RecyclerView.Adapter<PastOrdersAdapter.TrackOrderViewHolder> {
    private ArrayList<TrackOrderModel> trackOrderList;

    public PastOrdersAdapter(ArrayList<TrackOrderModel> trackOrderList) {
